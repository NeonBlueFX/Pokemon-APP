...
export const POKEMON_DATA_SUFFIX = `https://pokeapi.co/api/v2/pokemon?limit=20&offset=`

export const POKEMON_DATA_SUFFIX_LIMIT4 = `https://pokeapi.co/api/v2/pokemon?limit=4&offset=`
